...
def get_args():
    ...
    parser.add_argument('--continue_from_iter', nargs="?", type=int, default=-1, help='Continue from checkpoint of epoch')
    ...
    parser.add_argument('--number_of_steps_per_iter', type=int, default=1, help='Number of classes to sample per set')
    parser.add_argument('--cnn_num_filters', type=int, default=64, help='Number of classes to sample per set')
    parser.add_argument('--cnn_blocks_per_hyper_layer', type=int, default=1,
